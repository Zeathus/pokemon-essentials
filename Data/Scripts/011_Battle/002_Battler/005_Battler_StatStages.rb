class Battle::Battler
  ...
  def pbCanLowerStatStage?(stat, user = nil, move = nil, showFailMsg = false, ignoreContrary = false, ignoreMirrorArmor = false)
    return false if fainted?
<<<<<<< HEAD:Data/Scripts/011_Battle/001_Battler/005_Battler_StatStages.rb
    showFailMsg = false if @battle.predictingDamage
    # Contrary
    if hasActiveAbility?(:CONTRARY) && !ignoreContrary && !@battle.moldBreaker
...
>>>>>>> 479aeacc2c9dddad1b701c1a92a2a1f915e34388:Data/Scripts/011_Battle/002_Battler/005_Battler_StatStages.rb
    end
