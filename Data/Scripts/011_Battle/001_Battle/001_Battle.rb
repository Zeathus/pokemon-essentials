...
class Battle
  ...
  def pbOwnedByPlayer?(idxBattler)
    return false if $game_switches[AI_TAKEOVER]
...
<<<<<<< HEAD:Data/Scripts/011_Battle/003_Battle/002_PokeBattle_Battle.rb
      duration += BattleHandlers.triggerWeatherExtenderItem(user.item,
=======
      duration = Battle::ItemEffects.triggerWeatherExtender(user.item,
>>>>>>> 479aeacc2c9dddad1b701c1a92a2a1f915e34388:Data/Scripts/011_Battle/001_Battle/001_Battle.rb
...
>>>>>>> 479aeacc2c9dddad1b701c1a92a2a1f915e34388:Data/Scripts/011_Battle/001_Battle/001_Battle.rb
  ...
  def pbAnimation(move,user,targets,hitNum=0,damage=nil)
    @scene.pbAnimation(move,user,targets,hitNum,damage) if @showAnims
  end
