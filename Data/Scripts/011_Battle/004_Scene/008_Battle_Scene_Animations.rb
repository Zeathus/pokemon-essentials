...
class Battle::Scene::Animation::Intro < Battle::Scene::Animation
  ...
  def makeSlideSprite(spriteName,deltaMult,appearTime,origin=nil)
    ...
    s.setDelta(0,(512*deltaMult).floor,0)
    s.moveDelta(0,appearTime,(-512*deltaMult).floor,0)
  end
end
...
class Battle::Scene::Animation::LineupAppear < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    dir = (@side==0) ? 1 : -1
    bar.setDelta(0,dir*512/2,0)
    bar.moveDelta(0,8,-dir*512/2,0)
  ...
  def createBall(idxBall,delay,dir)
    ...
    ball.setDelta(delay,dir*512/2,0)
    ball.moveDelta(delay,8,-dir*512/2,0)
  end
end
...
class Battle::Scene::Animation::DataBoxAppear < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    dir = ((@idxBox%2)==0) ? 1 : -1
    box.setDelta(0,dir*512/2,0)
    box.moveDelta(0,8,-dir*512/2,0)
  end
end
...
class Battle::Scene::Animation::TrainerAppear < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    if @idxTrainer>0 && @sprites["trainer_#{@idxTrainer}"].visible
      ...
      oldTrainer.moveDelta(delay,8,512/4,0)
...
<<<<<<< HEAD:Data/Scripts/011_Battle/005_Battle scene/002_PokeBattle_SceneAnimations.rb
...
>>>>>>> 479aeacc2c9dddad1b701c1a92a2a1f915e34388:Data/Scripts/011_Battle/004_Scene/008_Battle_Scene_Animations.rb
      ...
      newTrainer.moveDelta(delay,8,-512/4,0)
    end
  end
end
...
class Battle::Scene::Animation::PlayerFade < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    while @sprites[spriteNameBase+"_#{i}"]
      ...
      trainer.moveDelta(0,16,-512/2,0)
    ...
    if @sprites["partyBar_0"] && @sprites["partyBar_0"].visible
      ...
      partyBar.moveDelta(delay,16,-512/4,0) if @fullAnim
    ...
    for i in 0...Battle::Scene::NUM_BALLS
      ...
      partyBall.moveDelta(delay+2*i,16,-512,0) if @fullAnim
...
class Battle::Scene::Animation::TrainerFade < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    while @sprites[spriteNameBase+"_#{i}"]
      ...
      i += 1
      next if !trSprite.visible || trSprite.x>512
...
class Battle::Scene::Animation::PokeballThrowDeflect < Battle::Scene::Animation
  ...
  def createProcesses
    ...
    ball.moveXY(delay,8,-32,384-96+32)   # Back to player's corner
