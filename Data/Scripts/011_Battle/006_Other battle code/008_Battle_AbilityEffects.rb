...
<<<<<<< HEAD:Data/Scripts/011_Battle/003_BattleHandlers_Abilities.rb
...
=======
    next pri + 1 if (Settings::MECHANICS_GENERATION <= 6 || battler.hp == battler.totalhp) &&
                  move.type == :FLYING
>>>>>>> 479aeacc2c9dddad1b701c1a92a2a1f915e34388:Data/Scripts/011_Battle/006_Other battle code/008_Battle_AbilityEffects.rb
  }
)
