...
def pbMiniQuestPromotion(count)
  ...
  if count==1
    ...
    Kernel.pbReceiveItem(PBItems::POKEBALL,20)
    refresh=true
  elsif count==2
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::GREATBALL,20)
    refresh=true
  elsif count==6
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::ULTRABALL,20)
    refresh=true
  elsif count==12
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::ABILITYCAPSULE,2)
    refresh=true
  elsif count==20
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::BOTTLECAP,5)
    refresh=true
  elsif count==30
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::GOLDBOTTLECAP,1)
    refresh=true
  elsif count==100
    pbSpeech("Receptionist", "none",
    ...
    pbSpeech("Receptionist", "none",
      "Here is your reward for this achievement.")
    Kernel.pbReceiveItem(PBItems::MASTERBALL,1)
    refresh=true
  elsif count==1000
    pbSpeech("Receptionist", "none",
    ...
    Kernel.pbReceiveItem(PBItems::PRETTYWING,1)
  end
  if refresh
...
def pbRandomRewardItem(difficulty)
  ...
  items = [
    ...
    [PBItems::NUGGET,
     ...
     PBItems::LIFEORB,
     PBItems::PPUP,
     PBItems::ABILITYCAPSULE,
     PBItems::ASSAULTVEST,
     PBItems::BOTTLECAP],
    # Difficulty 4
    [PBItems::BIGNUGGET,
     PBItems::PPMAX,
     PBItems::HABILITYCAPSULE,
     PBItems::GOLDBOTTLECAP],
    # Difficulty 5
    [PBItems::COMETSHARD,
     PBItems::MASTERBALL,
     PBItems::GOLDBOTTLECAP]
...
def pbLegendaryPokemon
  return [
    ...
    PBSpecies::MEWTWO, PBSpecies::MEW,
    PBSpecies::RAIKOU, PBSpecies::ENTEI, PBSpecies::SUICUNE,
    PBSpecies::LUGIA, PBSpecies::HOOH,
    PBSpecies::CELEBI,
    PBSpecies::ROTOM,
    PBSpecies::REGIROCK, PBSpecies::REGICE, PBSpecies::REGISTEEL,
    PBSpecies::LATIAS, PBSpecies::LATIOS,
    PBSpecies::KYOGRE, PBSpecies::GROUDON, PBSpecies::RAYQUAZA,
    PBSpecies::JIRACHI,
    PBSpecies::DEOXYS,
    PBSpecies::UXIE, PBSpecies::MESPRIT, PBSpecies::AZELF,
    PBSpecies::DIALGA, PBSpecies::PALKIA, PBSpecies::GIRATINA,
    PBSpecies::HEATRAN,
    PBSpecies::REGIGIGAS,
    PBSpecies::CRESSELIA, PBSpecies::DARKRAI,
    PBSpecies::PHIONE, PBSpecies::MANAPHY,
    PBSpecies::SHAYMIN, PBSpecies::ARCEUS,
    PBSpecies::VICTINI,
    PBSpecies::COBALION, PBSpecies::TERRAKION, PBSpecies::VIRIZION,
    PBSpecies::TORNADUS, PBSpecies::THUNDURUS, PBSpecies::LANDORUS,
    PBSpecies::RESHIRAM, PBSpecies::ZEKROM, PBSpecies::KYUREM,
    PBSpecies::KELDEO,
    PBSpecies::MELOETTA,
    PBSpecies::GENESECT,
    PBSpecies::XERNEAS, PBSpecies::YVELTAL, PBSpecies::ZYGARDE,
    PBSpecies::DIANCIE,
    PBSpecies::HOOPA,
    PBSpecies::VOLCANION,
    PBSpecies::TYPENULL, PBSpecies::SILVALLY,
    PBSpecies::TAPUKOKO, PBSpecies::TAPULELE,
    PBSpecies::TAPUBULU, PBSpecies::TAPUFINI,
    PBSpecies::COSMOG, PBSpecies::COSMOEM,
    PBSpecies::SOLGALEO, PBSpecies::LUNALA,
    PBSpecies::NIHILEGO,
    PBSpecies::BUZZWOLE, PBSpecies::PHEROMOSA,
    PBSpecies::XURKITREE,
    PBSpecies::CELESTEELA, PBSpecies::KARTANA,
    PBSpecies::GUZZLORD,
    PBSpecies::NECROZMA,
    PBSpecies::MAGEARNA,
    PBSpecies::MARSHADOW,
    PBSpecies::POIPOLE, PBSpecies::NAGANADEL,
    PBSpecies::STAKATAKA, PBSpecies::BLACEPHALON,
    PBSpecies::ZERAORA
  ]
end
...
def pbStaticPokemon
  return [
    PBSpecies::ROTOM,
    PBSpecies::ZORUA, PBSpecies::ZOROARK,
    PBSpecies::DEINO, PBSpecies::ZWEILOUS, PBSpecies::HYDREIGON,
    PBSpecies::LARVESTA, PBSpecies::VOLCARONA
  ]
end
...
def pbRandomTrainerType(gender=nil)
  male=[
    ...
    PBTrainers::SCHOOLBOY,
    PBTrainers::PRESCHOOLER_M,
    PBTrainers::PKMNBREEDER_M,
    PBTrainers::PKMNRANGER_M,
    PBTrainers::BACKPACKER_M,
    PBTrainers::FISHERMAN,
    PBTrainers::GUITARIST,
    PBTrainers::PAINTER,
    PBTrainers::RICHBOY,
    PBTrainers::SCIENTIST_M,
    PBTrainers::BLACKBELT,
    PBTrainers::JANITOR,
    PBTrainers::PKMNFAN_M,
    PBTrainers::DOCTOR,
    PBTrainers::HIKER
  ]
  female=[
    PBTrainers::LASS,
    PBTrainers::SCHOOLGIRL,
    PBTrainers::NURSERYAID,
    PBTrainers::PRESCHOOLER_F,
    PBTrainers::PKMNBREEDER_F,
    PBTrainers::PKMNRANGER_F,
    PBTrainers::BACKPACKER_F,
    PBTrainers::BAKER,
    PBTrainers::LIBRARIAN,
    PBTrainers::LADY,
    PBTrainers::SCIENTIST_F,
    PBTrainers::CRUSHGIRL,
    PBTrainers::PKMNFAN_F,
    PBTrainers::NURSE,
    PBTrainers::PARASOLLADY
  ]
  if gender
    if gender==0
