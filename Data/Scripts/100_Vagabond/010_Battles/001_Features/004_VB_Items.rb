#ItemHandlers::UseFromBag.add(:SCHOOLBOOK,proc{|item|
#    next 2
# })
# 
# ItemHandlers::UseFromBag.add(:EEVEEBOOK,proc{|item|
#    next 2
# })
 

#ItemHandlers::UseInField.add(:SCHOOLBOOK,proc{|item|
#    pbReadBook("book")
# })
# 
# ItemHandlers::UseInField.add(:EEVEEBOOK,proc{|item|
#    pbReadBook("eevee")
# })
