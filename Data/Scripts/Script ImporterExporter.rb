  ...
  if IMPORT_EXPORT_MODE >= 2
    ...
    File.open("#{FOLDER_NAME}/!script_order.csv", 'r') do |list| 
      ...
      list.each do |filename|
        ...
        format_script_name = script_name
        if format_script_name.include?("@@")
          format_script_name = script_name[6...script_name.length]
          format_script_name = "# " + format_script_name + " #"
        elsif format_script_name.include?("@")
          format_script_name = script_name[5...script_name.length]
          format_script_name = "### " + format_script_name + " ###"
        elsif !script_name[/#{BLANK_SCRIPT_TAG}$/]
          format_script_name = script_name[4...script_name.length]
        end
        import_obj[counter] = [counter]
        import_obj[counter][1] = format_script_name
